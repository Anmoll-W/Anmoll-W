...
| [The Boot Sequence Was in the Docs. So Was Every Skipped Step.](https://github.com/Anmoll-W/blog/blob/main/posts/claude-code-boot-sequence-as-infrastructure.md) | 104 Claude Code sessions analyzed, three recurring failure patterns found — and fixed by moving the session boot sequence from CLAUDE.md text into a SessionStart hook that fires every time. Covers five new workflow rules, five slash commands, and the gap between instructions that remind and infrastructure that enforces
| [The Vault Was Organized. The Files Were Not.](https://github.com/Anmoll-W/blog/blob/main/posts/vault-structural-drift.md) | A dry run moved 31 files — structural drift that had accumulated invisibly across 6 weeks. How a nightly vault-organizer automation enforces placement rules, patches wikilinks, creates missing index stubs, and logs every change
