...
| [I Spent an Afternoon Making My Terminal Feel Alive](https://github.com/Anmoll-W/blog/blob/main/posts/ghostty-terminal-alive.md) | Why I uninstalled Warp the same day I installed it, switched to Ghostty, and built a script that loads a random GPU shader and theme on every session
