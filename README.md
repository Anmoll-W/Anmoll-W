...
| [Agents That Do Not Learn: Rebuilding the Self-Improvement Layer from First Principles](https://github.com/Anmoll-W/blog/blob/main/posts/agents-that-dont-learn.md) | 13 AI agents, 60 sessions of history, zero self-improvement — the architectural changes that fixed it: Reflexion Block, memory decay flags, a user profile mined from session history, and path-scoped rules
